 ...
 * Description: buffers chained commands
 ...
 * Description: gets a line minus the newline
 * @info: parameter struct
 * Return: bytes read
 */
 ...
 * Description: gets the next line of input from STDIN
 * @info: parameter struct
